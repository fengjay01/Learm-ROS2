...
ros2 action send_goal /learm_group_controller/follow_joint_trajectory control_msgs/action/FollowJointTrajectory "{
  trajectory: {
    ...
    points: [
      ...
      { positions: [0.2, 0.5, 0.2 ,0.2, 0.2, -1.57], time_from_start: { sec: 5, nanosec: 500 } },
